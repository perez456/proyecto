...
<div class="row">
	<div class="col">
		<form action="./index.php" method="post" accept-charset="utf-8" class="form-inline">
			<div  style="text-align: right" class="form-group mx-sm-2 mb-2">
				...
				?>
							...
							<tr codigoCita="row<?php echo $value['codigoCita']; ?>">
								...
								<!--<td class="text-center">
									<a href="./index.php?page=edit&codigoCita=<?php /*echo $value['codigoCita'] ?>" title="Editar cita: <?php echo $value['codigoCita'] ?>">
